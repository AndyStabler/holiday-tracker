...
class TimeOffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_off" do
    assert_difference("TimeOff.count") do
      post time_offs_url, params: { time_off: { afternoon: @time_off.afternoon, date: @time_off.date, more_info: @time_off.more_info, morning: @time_off.morning, user_id: @time_off.user_id } }
    end
  ...
  test "should update time_off" do
    patch time_off_url(@time_off), params: { time_off: { afternoon: @time_off.afternoon, date: @time_off.date, more_info: @time_off.more_info, morning: @time_off.morning, user_id: @time_off.user_id } }
